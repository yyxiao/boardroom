...
-- 机构初始化
INSERT INTO "brms"."sys_org" ("id", "org_name", "org_type", "parent_id", "org_manager", "phone", "address", "org_seq", "state", "create_time", "create_user", "update_time") VALUES ('1', '母公司', '0', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
