...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('显示 %s 到 %s 项，共 %s 项', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            '<div class="pull-right pagination">',
                '<ul class="pagination">',
                    '<li class="page-first"><a href="javascript:void(0)">第一页</a></li>',
        ...
        html.push(
                    ...
                    '<li class="page-last"><a href="javascript:void(0)">最后一页</a></li>',
                '</ul>',
            '</div>');
