    ...
    e._temp_matrix_scope = function() {
        ...
        function d(a) {
            ...
            for (var v = 0; v < this.y_unit.length; v++) {
                ...
                this.section_autoheight && (this.y_unit.length * y.height < a.offsetHeight && (y.height = Math.max(y.height, Math.floor((a.offsetHeight - 1) / this.y_unit.length))), this._section_height[this.y_unit[v].key] = y.height),
