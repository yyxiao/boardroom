...
def auth_include(config):
    ...
    config.add_route('to_auth_role', '/to_auth_role')
    config.add_route('update_auth_role', '/update_auth_role')
...
def mobile_include(config):
    ...
    config.add_route('mobile_delete_meeting', '/deleteMeeting')
    ...
    config.add_route('mobile_org_meeting_list', '/orgRoomList')
