...
def get_pre_DataDateQuarter(dataDate):
    '''返回当前数据日期前一季度'''
    syear =str(dataDate[0:4])
    smonth = int(dataDate[5:6])
    smonth=smonth-3
...
def get_month_range():
    '''月范围: 2012-01~2030-12'''
    return ['2012-01','2012-02','2012-03','2012-04','2012-05','2012-06','2012-07','2012-08','2012-09','2012-10','2012-11','2012-12',
